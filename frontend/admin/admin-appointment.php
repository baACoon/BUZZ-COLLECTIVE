                ...
                <table class="appointments-table">
                    ...
                    <tbody>
                        ...
                        foreach ($appointments as $appointment) {
                            ...
                            ? "<a href='#' class='view-receipt' onclick=\"showReceiptModal('https://buzzcollective.gayvar.com/BUZZ-COLLECTIVE/frontend/uploads/receipts/{$appointment['receipt']}')\">View Receipt</a>" 
                            : 'No Receipt Uploaded';
